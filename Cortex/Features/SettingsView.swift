...
struct SettingsView: View {
    ...
    // The selected settings tab, driven by the Liquid Glass segmented control below.
    ...
    var body: some View {
        ...
        VStack(spacing: 0) {
            ...
            GlassSegmentedControl(items: SettingsTab.allCases, selection: $selectedTab) { $0.title }
